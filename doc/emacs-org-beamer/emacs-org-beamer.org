...
#+LATEX_HEADER: \mode<beamer>{\usetheme{CambridgeUS} \usecolortheme{beaver} \setbeamertemplate{items}[ball] \setbeamertemplate{blocks}[rounded][shadow=true] \useoutertheme{infolines}}
