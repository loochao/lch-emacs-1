...
\begin{center}
     \Large{\textbf{LooChao Emacs Cheat Sheet}} \\
\end{center}

\section{Keyboard Shortcuts}
\begin{tabular}{@{}ll@{}}
\verb!M-f1:!      & search in firefox.\\
\verb!M-f2:!      & search in w3m.\\
\verb!g:!         & google.\\
\verb!g:!         & google symbol at point.\\
...
\\
\hline
\verb!f1 f1:!    & start shell inside emacs.\\
\verb!f1 f2:!    & start terminal. (Mac)\\
\verb!f2 f2:!    & go to last change\\
\verb!f3 f3:!    & w3m browse url.\\
\verb!f3 f2:!    & switch to existing w3m.\\
\verb!f4 f4:!    & open finder. (Mac)\\
\verb!f5 f5:!    & bmk list.\\
\verb!f6 f6:!    & bm toggle.\\
\verb!f7 f6:!    & dict search (dict.el).\\
\verb!f7 f7:!    & dict search symbol (w3m icba).\\
\verb!f9 f9:!    & hl symbol\\
\verb!f10 f10:!  & \\
\verb!f11 f11:!  & \\
\verb!f12 f12:!  & emms playlist\\
\\
\hline
\verb!M-1:!      & start shell inside emacs.\\
\verb!M-g:!      & goto char.\\
\verb!M-k:!  & kill this buffer.\\

\hline
\verb!M-z:!      & zap to char.\\
\verb!M-z e:!    & deletes all characters to the next 'e'.\\
\verb!C-u 2 M-z e:!    & deletes all character to the second 'e'.\\
\verb!C-- M-z e:!      & deletes all characters to the previous 'e'\\

\\
\hline
\verb!f5-f5:!    & bmk list.\\
\verb!C-f5:!     & jump to bmk.\\
\verb!S-f5:!     & set bmk.\\

\\
\hline
\verb!C-f11:!    & menu bar toggle.\\
\verb!S-f11:!    & toolbar toggle.\\
\verb!M-f11:!    & line num toggle.\\
\verb!C-M-f11:!  & tabbar toggle.\\
\verb!C-S-f11:!  & ruler toggle.\\

\\
\hline
\verb!f2  s:!    & spell-mode toggle.\\

\hline
\verb!f11 c:!    & lang env gb18030.\\
\verb!f11 u:!    & lang env utf8.\\

\\
\hline
\verb!C-x f:!    & find file at point.\\
\verb!C-x C-f:!  & open file.\\
\verb!C-c f:!    & run find in dir.\\
\verb!C-x g:!    & goto char.\\
\verb!C-c g:!    & run grep in dir.\\
\verb!C-c n:!    & nuke buffers.\\

\\
\hline
w3m-mode\\
\verb!d:!        & kill curren page.\\
\verb!hjkl:!     & vim traditional move.\\
\verb!H:!        & history.\\
\verb!we:!       & history back/forward.\\
\verb![]:!       & history back/forward.\\
\verb!np:!       & next/prev buffer.\\
...
\verb!artist-mode!        & .\\
\verb!rainbow-mode!        & .\\
\verb!whitespace-mode!        & .\\
\verb!el-doc!        & display help for elisp func.\\
\end{tabular}

\section{M-x}
\begin{tabular}{@{}ll@{}}
\verb!list-colors-display!        & list colors.\\
\verb!re-builder!        & helper to build reg exp.\\
\verb!describe-text-properties! & Find which faces are used at point.\\
\end{tabular}


\section{Elegant Colors}
\begin{tabular}{@{}ll@{}}
  \verb!SlateBlue!        & .\\
  \verb!DarkSeaGreen!        & .\\
\end{tabular}
...
\begin{tabular}{@{}ll@{}}
\verb!C-h v features!      & list all the packages loaded.\\
\verb!leisure read!        & C-. C-, C-'\\
\\
\verb!replace regexp!      & C-M-%\\
\\
\verb!narrow-to-region!    & C-x n n (show region only)\\
\verb!widen!               & C-x n w \\
\\
\verb!copy-to-register!      & C-x r s, (prompt you to insert register
name)\\
\verb!insert-from-register!  & C-x r i \\
\verb!zap-to-char!           & delete all the chars until next one.\\
