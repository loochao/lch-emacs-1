...
(define-key global-map (kbd "M-<f1> b") '(lambda() (interactive) (lch-search-by "baidu" "ffx" nil)))
(define-key global-map (kbd "M-<f1> c") '(lambda() (interactive) (lch-search-by "ciba" "ffx" nil)))
(define-key global-map (kbd "M-<f1> d") '(lambda() (interactive) (lch-search-by "definition" "ffx" nil)))
(define-key global-map (kbd "M-<f1> f") '(lambda() (interactive) (lch-search-by "google-file" "ffx" nil)))
(define-key global-map (kbd "M-<f1> g") '(lambda() (interactive) (lch-search-by "google" "ffx" nil)))
(define-key global-map (kbd "M-<f1> w") '(lambda() (interactive) (lch-search-by "wikipedia" "ffx" nil)))

(define-key global-map (kbd "M-<f1> B") '(lambda() (interactive) (lch-search-by "baidu" "ffx" t)))
(define-key global-map (kbd "M-<f1> C") '(lambda() (interactive) (lch-search-by "ciba" "ffx" t)))
(define-key global-map (kbd "M-<f1> D") '(lambda() (interactive) (lch-search-by "definition" "ffx" t)))
(define-key global-map (kbd "M-<f1> F") '(lambda() (interactive) (lch-search-by "google-file" "ffx" t)))
(define-key global-map (kbd "M-<f1> G") '(lambda() (interactive) (lch-search-by "google" "ffx" t)))
(define-key global-map (kbd "M-<f1> W") '(lambda() (interactive) (lch-search-by "wikipedia" "ffx" t)))

(define-key global-map (kbd "M-<f2> b") '(lambda() (interactive) (lch-search-by "baidu" "w3m" nil)))
(define-key global-map (kbd "M-<f2> c") '(lambda() (interactive) (lch-search-by "ciba" "w3m" nil)))
(define-key global-map (kbd "M-<f2> d") '(lambda() (interactive) (lch-search-by "definition" "w3m" nil)))
(define-key global-map (kbd "M-<f2> f") '(lambda() (interactive) (lch-search-by "google-file" "w3m" nil)))
(define-key global-map (kbd "M-<f2> g") '(lambda() (interactive) (lch-search-by "google" "w3m" nil)))
(define-key global-map (kbd "M-<f2> w") '(lambda() (interactive) (lch-search-by "wikipedia" "w3m" nil)))

(define-key global-map (kbd "M-<f2> B") '(lambda() (interactive) (lch-search-by "baidu" "w3m" t)))
(define-key global-map (kbd "M-<f2> C") '(lambda() (interactive) (lch-search-by "ciba" "w3m" t)))
(define-key global-map (kbd "<f7> <f7>") '(lambda() (interactive) (lch-search-by "ciba" "w3m" t)))
(define-key global-map (kbd "M-<f2> D") '(lambda() (interactive) (lch-search-by "definition" "w3m" t)))
(define-key global-map (kbd "M-<f2> F") '(lambda() (interactive) (lch-search-by "google-file" "w3m" t)))
(define-key global-map (kbd "M-<f2> G") '(lambda() (interactive) (lch-search-by "google" "w3m" t)))
(define-key global-map (kbd "M-<f2> W") '(lambda() (interactive) (lch-search-by "wikipedia" "w3m" t)))
