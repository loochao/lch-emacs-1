...
(define-key global-map (kbd "M-o b") '(lambda() (interactive) (lch-search-by "baidu" "ffx" nil)))
(define-key global-map (kbd "M-o c") '(lambda() (interactive) (lch-search-by "ciba" "ffx" nil)))
(define-key global-map (kbd "M-o d") '(lambda() (interactive) (lch-search-by "definition" "ffx" nil)))
(define-key global-map (kbd "M-o f") '(lambda() (interactive) (lch-search-by "google-file" "ffx" nil)))
(define-key global-map (kbd "M-o g") '(lambda() (interactive) (lch-search-by "google" "ffx" nil)))
(define-key global-map (kbd "M-o w") '(lambda() (interactive) (lch-search-by "wikipedia" "ffx" nil)))

(define-key global-map (kbd "M-o B") '(lambda() (interactive) (lch-search-by "baidu" "ffx" t)))
(define-key global-map (kbd "M-o C") '(lambda() (interactive) (lch-search-by "ciba" "ffx" t)))
(define-key global-map (kbd "M-o D") '(lambda() (interactive) (lch-search-by "definition" "ffx" t)))
(define-key global-map (kbd "M-o F") '(lambda() (interactive) (lch-search-by "google-file" "ffx" t)))
(define-key global-map (kbd "M-o G") '(lambda() (interactive) (lch-search-by "google" "ffx" t)))
(define-key global-map (kbd "M-o W") '(lambda() (interactive) (lch-search-by "wikipedia" "ffx" t)))

(define-key global-map (kbd "M-p b") '(lambda() (interactive) (lch-search-by "baidu" "w3m" nil)))
(define-key global-map (kbd "M-p c") '(lambda() (interactive) (lch-search-by "ciba" "w3m" nil)))
(define-key global-map (kbd "<f7> <f8>") '(lambda() (interactive) (lch-search-by "ciba" "w3m" t)))
(define-key global-map (kbd "M-p d") '(lambda() (interactive) (lch-search-by "definition" "w3m" nil)))
(define-key global-map (kbd "M-p f") '(lambda() (interactive) (lch-search-by "google-file" "w3m" nil)))
(define-key global-map (kbd "M-p g") '(lambda() (interactive) (lch-search-by "google" "w3m" nil)))
(define-key global-map (kbd "M-p w") '(lambda() (interactive) (lch-search-by "wikipedia" "w3m" nil)))

(define-key global-map (kbd "M-p B") '(lambda() (interactive) (lch-search-by "baidu" "w3m" t)))
(define-key global-map (kbd "M-p C") '(lambda() (interactive) (lch-search-by "ciba" "w3m" t)))
(define-key global-map (kbd "<f7> <f7>") '(lambda() (interactive) (lch-search-by "ciba" "w3m" t)))
(define-key global-map (kbd "M-p D") '(lambda() (interactive) (lch-search-by "definition" "w3m" t)))
(define-key global-map (kbd "M-p F") '(lambda() (interactive) (lch-search-by "google-file" "w3m" t)))
(define-key global-map (kbd "M-p G") '(lambda() (interactive) (lch-search-by "google" "w3m" t)))
(define-key global-map (kbd "M-p W") '(lambda() (interactive) (lch-search-by "wikipedia" "w3m" t)))
