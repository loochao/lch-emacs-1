...
;(define-key global-map (kbd "<f5> c") 'org-center-skeleton) ;> skeleton.el
;(define-key global-map (kbd "<f5> e") 'org-example-skeleton) ;> skeleton.el
;(define-key global-map (kbd "<f5> h") 'org-head-skeleton) ;> skeleton.el
;(define-key global-map (kbd "<f5> i") 'org-image-skeleton) ;> skeleton.el
;(define-key global-map (kbd "<f5> s l") 'org-src-lisp-skeleton) ;> skeleton.el
...
;(define-key global-map (kbd "<f11> <f1>") 'color-theme-arjen)         ;~~> ui-theme.el
...
;(define-key global-map (kbd "<f11> u") (set-language-environment "UTF-8"))            ;~~> lch-coding.el
; <f11> U ->>> revert buffer with utf-8                                         ;~~> lch-coding.el
;(define-key global-map (kbd "<f11> c") (set-language-environment "Chinese-GB18030"))  ;~~> lch-coding.el
