...
;;       emms-info-mp3info-coding-system 'utf-8-emacs
...
(setq emms-playlist-buffer-name "*EMMS Playlist*"
      emms-source-file-default-directory "~/Dropbox/MUSIC"
...
(unless (memq system-type '(darwin windows-nt))
  ...
  (define-key global-map (kbd "M-0") 'emms-volume-raise)
  (define-key global-map (kbd "M-9") 'emms-volume-lower))
...
(define-key global-map (kbd "C-c e x")   'emms-start)
(define-key global-map (kbd "C-c e v")   'emms-stop)

(define-key global-map (kbd "C-c e n")   'emms-next)
(define-key global-map (kbd "C-c e p")   'emms-previous)
(define-key global-map (kbd "C-c e >")   'emms-cue-next)
(define-key global-map (kbd "C-c e <")   'emms-cue-previous)

(define-key global-map (kbd "C-c e o")   'emms-show)
(define-key global-map (kbd "C-c e h")   'emms-shuffle)
(define-key global-map (kbd "C-c e SPC") 'emms-pause)
(define-key global-map (kbd "C-c e f")   'emms-no-next)
(define-key global-map (kbd "C-c e F")   'emms-no-next-and-sleep)
(define-key global-map (kbd "C-c e d")   'emms-playlist-mode-delete-selected-track)
(define-key global-map (kbd "C-c e r")   'emms-toggle-repeat-track)
(define-key global-map (kbd "C-c e R")   'emms-toggle-repeat-playlist)
(define-key global-map (kbd "C-c e l")   'emms-lyrics-toggle-display-buffer)
(define-key global-map (kbd "C-c e L")   'emms-lyrics-visit-lyric)

(define-key global-map (kbd "C-c e s")   'emms-lastfm-radio-similar-artists)
(define-key global-map (kbd "C-c e k")   'emms-lastfm-radio-skip)
...
(define-key global-map (kbd "C-c e L") 'xwl-emms-lyrics-find-lyric)
...
(define-key global-map (kbd "C-c e S") 'emms-lyrics-save-w3m-buffer)
